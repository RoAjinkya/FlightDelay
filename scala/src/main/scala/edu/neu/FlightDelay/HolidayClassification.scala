...
object HolidayClassification {
  ...
  def main(args: Array[String]): Unit = {
    ...
    System.setProperty("hadoop.home.dir", "..\\Project\\spark-2.1.0-bin-hadoop2.7")
    ...
    val dot = Source.fromFile("..\\Project\\TestData.csv")
    //val dot = Source.fromFile("C:\\NEU_IS\\Spring 2017\\Big Data Systems Engineering with SCALA\\Project\\TestData.csv")

    val dot_holiday = scala.tools.nsc.io.File("Holiday.csv")
  ...
  //====================================================================================================================
  def isHoliday(date: java.util.Date): Int ={
    //major holidays
